...
public class QuerySetting {
    ...
    public static class Reservation {
        ...
        public static final String SELECT_ONE_BY_THEME_ID = "SELECT 1 FROM reservation WHERE theme_id = ? LIMIT 1";
        public static final String SELECT_ONE_BY_THEME_ID_AND_DATE_AND_TIME = "SELECT 1 FROM reservation WHERE theme_id = ? AND date = ? AND time = ? LIMIT 1";
