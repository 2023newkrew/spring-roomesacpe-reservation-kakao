...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNoHandlerFoundException(NoHandlerFoundException e) {
        return handlerException(e, ErrorCode.API_NOT_FOUND);
    }
    ...
    public ResponseEntity<ErrorResponse> handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
        return handlerException(e, ErrorCode.INVALID_BODY_FIELD);
    }
    ...
    public ResponseEntity<ErrorResponse> handleConstraintViolationException(ConstraintViolationException e) {
        return handlerException(e, ErrorCode.INVALID_PATH_VAR_OR_QUERY_PARAMETER);
    }
    ...
    public ResponseEntity<ErrorResponse> handleOtherExceptions(Exception e) {
        return handlerException(e, ErrorCode.INTERNAL_SERVER_ERROR);
    }
